...
public class MailClientRecv {
    ...
    public static String myEmailPassword = "xieyrzkvzyojdebh";//这个密码不是QQ密码或者邮箱密码，要验证的。自己百度
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 4. Subject: 邮件主题
        message.setSubject("Nignx 邮件", "UTF-8");
        ...
        DataHandler dh = new DataHandler(new FileDataSource("E:\\SSMProject\\20190423151417.jpg")); // 读取本地文件
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("E:\\SSMProject\\day24-Nginx.docx"));  // 读取本地文件
